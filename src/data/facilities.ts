...
export const facilitiesData: FacilityItem[] = [
  ...
  // ==========================================
  {
    ...
    contentHtml: `
      ...
      <p>我們深知等待看診時的焦慮，因此特別設置了舒適的沙發區、免費無線網路 (Wi-Fi) 以及茶水服務。全院採<strong>無障礙設計</strong>，無論是推輪椅的長輩或推嬰兒車的家長，都能輕鬆進出，享有最友善的就醫體驗。</p>
    `,
  ...
  },
  {
    id: 'parking',
    title: '專屬停車位',
    description: '診所門口設有專屬停車空間，讓行動不便的患者免於奔波，就醫更便利。',
    keywords: ['復健科停車', '新竹好停車診所', '無障礙車位', '方便就醫'],
    contentHtml: `
      <p>在新竹市區就醫，停車往往是最大的困擾。宸新復健科體貼行動不便的患者，於診所門口規劃了<strong>專屬汽機車停車位</strong>。</p>
  ...
  // ==========================================
  {
    ...
    contentHtml: `
      ...
      <p>拍攝後影像直接傳輸至診間電腦，讓林羿辰醫師能即時為您解說骨骼結構。無論是意外受傷的<strong>骨折診斷</strong>、長輩的<strong>退化性關節炎</strong>程度評估，或是兒童的<strong>脊椎側彎</strong>篩檢，都能提供最客觀準確的影像依據。</p>
    `,
  ...
  },
  {
    ...
    contentHtml: `
      <p>相較於 X 光看骨頭，高解析度肌肉骨骼超音波 (Musculoskeletal Ultrasound) 能清楚看到<strong>肌腱、韌帶、神經與肌肉</strong>的動態狀況。</p>
      <p>搭配高階彩色都卜勒血流偵測 (Color Doppler)，能精準判斷發炎程度。最重要的是，我們堅持進行<strong>超音波導引注射</strong>，看著螢幕下針，將 PRP 或增生藥劑準確送達病灶，避免誤傷神經血管，大幅提升治療成功率。</p>
    `,
  ...
  // ==========================================
  {
    ...
    contentHtml: `
      <p>引進瑞士頂級 EMS 聚焦式震波儀，利用高能量聲波穿透組織，精準聚焦於深層病灶，能有效<strong>擊碎鈣化組織</strong>並刺激微血管新生。</p>
  ...
  },
  {
    ...
    contentHtml: `
      ...
      <p>本院採用衛福部核准之高階 PRP 專用套管與高速離心設備，全程在無菌環境下操作，能有效分離紅血球，萃取出生長因子濃度極高且純淨的血小板血漿，最大化軟骨與韌帶的修復效果。</p>
    `,
  ...
  },
  {
    ...
    contentHtml: `
      <p>高能量雷射能穿透至深層組織，透過光生物調節作用 (Photobiomodulation) 抑制發炎反應，並加速細胞粒線體產生能量 (ATP)。</p>
      <p>對於<strong>急性腳踝扭傷消腫、肌肉拉傷修復</strong>效果極佳，能大幅縮短受傷後的恢復時間，是職業運動員常備的治療利器。</p>
    `,
  ...
  // ==========================================
  {
    ...
    contentHtml: `
      <p>我們的骨科復健區空間寬敞明亮，依據功能劃分為<strong>電療熱敷區</strong>與<strong>運動治療區</strong>。</p>
      <p>除了傳統的干擾波、頸腰椎牽引機外，更配備了各類肌力訓練器材、平衡球與彈力帶。由專業物理治療師指導，針對五十肩、下背痛或骨折術後患者，制定漸進式的復健計畫，協助您找回健康的身體功能。</p>
    `,
  ...
  },
  {
    ...
    keywords: ['徒手治療', '新竹整骨', '筋膜放鬆', '一對一物理治療', '私密空間'],
    contentHtml: `
  ...
  },
  {
    ...
    keywords: ['兒童早療', '感覺統合', '發展遲緩', '新竹兒童復健', '早療教室'],
    contentHtml: `
      <p>為了讓怕生的孩子能卸下心防，我們打造了色彩繽紛、充滿童趣的<strong>兒童早療專區</strong>。</p>
      <p>配備攀岩牆、盪鞦韆、球池與平衡木等感覺統合器材。專業的職能治療師與物理治療師透過「遊戲治療」的方式，引導發展遲緩、專注力不足或肌肉張力異常的孩子，在快樂玩耍中同步提升大腦與肢體的協調能力。</p>
    `,
    imageUrl: 'https://images.unsplash.com/photo-1560732357-d209d799042b?auto=format&fit=crop&q=80&w=800'
  },
  ...
  },
  {
    ...
    keywords: ['器械皮拉提斯', 'Reformer', '核心床', '脊椎保健', '體態雕塑'],
    contentHtml: `
      <p>本院引進專業的<strong>皮拉提斯核心床 (Reformer)</strong>，結合復健醫學原理，由物理治療師親自指導。</p>
      <p>利用彈簧阻力輔助，能更安全、精準地訓練核心肌群、延展脊椎並增加關節活動度。非常適合脊椎側彎矯正、下背痛復健，以及追求優美體態線條的女性朋友。</p>
    `,
  ...
  },
  {
    ...
    `,
    imageUrl: 'https://images.unsplash.com/photo-1596356453261-0d265ae2520a?auto=format&fit=crop&q=80&w=800'
  }
];
