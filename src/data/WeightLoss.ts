...
export const weightLossPrograms: WeightLossProgram[] = [
  {
    ...
    features: ['衛福部核可適應症藥物', '專業醫師評估用藥安全', '個人化劑量調整']
  },
  {
    slug: 'inbody',
    title: 'InBody 身體組成分析',
    ...
    features: ['精準測量體脂肪與骨骼肌', '分析內臟脂肪等級', '追蹤身體評分變化']
  },
  {
    slug: 'exercise',
    title: '運動處方規劃',
    ...
    features: ['物理治療師一對一指導', '客製化增肌減脂菜單', '預防運動傷害']
  },
  {
    slug: 'bone-age',
    title: '兒童骨齡評估',
    ...
    features: ['精準判讀骨骺閉合程度', '預測成年身高落點', '提供轉骨發育建議']
  }
];
