...
<div style="background-color: #f0fdf4; border-left: 5px solid #16a34a; border-radius: 0.5rem; padding: 1.5rem; margin: 2rem 0;">
  ...
  <p style="margin: 0; color: #166534; line-height: 1.8;">
    ...
    2022 年 FDA 亦核准週纖達用於 <strong>12 歲以上</strong> 青少年肥胖症，STEP TEENS 試驗（n＝201）顯示 BMI 下降 16.1%<sup><a href="https://doi.org/10.1056/NEJMoa2208601" target="_blank" rel="noopener noreferrer">[3]</a></sup>。
    其藥理機制已獲多篇神經科學與內分泌學研究闡明：藉由激活下視丘弧狀核（ARC）中的厭食性神經元（POMC/CART）並抑制促食性神經元（NPY/AgRP），同時延緩胃排空，達到持久抑制食慾之效果<sup><a href="https://doi.org/10.1111/dom.14280" target="_blank" rel="noopener noreferrer">[4]</a></sup><sup><a href="https://pmc.ncbi.nlm.nih.gov/articles/PMC11674233/" target="_blank" rel="noopener noreferrer">[5]</a></sup>。
