...
export const noticesData: NewsPost[] = [

  {
    ...
    category: '門診公告',
    date: '2026-02-06',
    summary: '因應過年前預約踴躍，下週二 (2/10) 早上林醫師加開門診，歡迎多加利用。',
    coverImage: '/images/notice/newyear/1.webp', // 建議製作一張包含 2/10 加開資訊的圖片
    
    // SEO 最佳化
    seoTitle: '【春節門診公告】2/10 林羿辰醫師加開門診 - 新竹宸新復健科',
    seoDescription: '農曆新年將至，為確保病患年前順利就診，新竹宸新復健科林羿辰醫師於 2/10 (二) 早上加開門診時段。',
    keywords: ['春節門診', '林羿辰醫師', '加開門診', '新竹復健科預約', '宸新復健科'],
    
    contentHtml: `
<p><strong>🧧 【春節門診加開公告】</strong></p>
<p>各位親愛的朋友大家好：</p>
<p>農曆新年將至，近期收到許多病患反映過年前夕林醫師預約幾乎額滿。為了確保大家在年前都能順利就診、安心過年，院長特別安排於 <strong>下週二 (2/10) 加開「早上門診」</strong>，歡迎有需要的民眾多加利用。</p>

<p><strong>⚠️ 溫馨小提示：</strong><br>
如果您已經預約其他時段，但想改至週二早上就診，<strong>請務必記得取消原先的預約</strong>，將名額釋出給更需要的病患喔！</p>

<hr>
<img src="/images/notice/newyear/1.webp" alt="春節門診加開公告" />
<p><strong>✦ 預約與看診提醒 ✦</strong></p>
<ul>
<li>本診所無電話掛號，請下載 APP 或使用線上系統預約。</li>
<li><strong>2/10 (二) 加開時段：</strong> 早上 09:00 - 12:00（依現場公告為準）。</li>
<li>網路預約者請於門診結束前一小時完成報到，避免影響看診權益。</li>
</ul>
