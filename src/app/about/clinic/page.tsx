    ...
    <>
      ...
      <div className="min-h-screen bg-slate-900 text-slate-300 pt-0 -mt-6 pb-12 md:pt-0 md:-mt-8 md:pb-16">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {/* ✨ 4. 標題區動畫 */}
          <div className="mb-12 text-center animate-on-scroll delay-100">
              ...
              <p className="text-xl text-slate-400 max-w-3xl mx-auto">
                工欲善其事，必先利其器。我們引進醫學中心等級的檢查與治療設備，並打造寬敞舒適的復健空間。
              </p>
          </div>
            ...
            {allItems.map((item, index) => {
              ...
              return (
                <Link 
                  ...
                  // ✨ 6. 加上動畫 class
                  className={`group bg-slate-800/50 backdrop-blur border border-slate-700 rounded-xl overflow-hidden hover:border-cyan-500 hover:shadow-[0_0_20px_rgba(34,211,238,0.2)] transition-all duration-300 flex flex-col animate-on-scroll ${delayClass}`}
                >
                    {/* 圖片區塊 */}
