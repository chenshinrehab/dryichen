...
export default function DiseaseCategoryPage({ params }: PageProps) {
  ...
  // Schema 2: 醫療列表頁面 (MedicalWebPage + ItemList)
  ...
  return (
    <>
      ...
      <div className="min-h-screen flex flex-col bg-slate-900 text-slate-300">
        ...
        <main className="flex-grow pt-0 pb-12 md:pt-0 md:pb-12  fade-in">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="mb-10">
                ...
                <Link 
                  href="/diseases" 
                  className="inline-flex items-center text-cyan-400 hover:text-cyan-300 mb-6 transition-colors group text-sm font-medium"
                >
            ...
            <div className="text-center border-t border-slate-800 pt-12">
                ...
                <Link href="/diseases" className="inline-flex items-center px-8 py-3 bg-slate-800 text-slate-300 rounded-full border border-slate-700 hover:bg-cyan-900/20 hover:text-cyan-400 hover:border-cyan-500/50 transition-all duration-300 shadow-lg">
