  ...
  return (
    <>
      ...
      <div className="min-h-screen flex flex-col bg-slate-900 text-slate-300">
        ...
        {/* --- 修改重點 1: 容器寬度限制為 max-w-5xl (參考 diseases/page.tsx) --- */}
        <main className="max-w-5xl mx-auto w-full px-4 pt-4 pb-12 md:pt-8 md:pb-16 fade-in">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            {/* 疾病卡片列表 
               --- 修改重點 2 & 3 & 4: 
               grid-cols-3 (3欄), h-48 (圖片高), gap-8 (間距)
               完全對齊 Reference 樣式
            */}
