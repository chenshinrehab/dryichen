        ...
        <p className="text-[10px] md:text-xs text-slate-400 tracking-wider leading-none mt-0.5">宸新復健科診所院長</p>
          ...
          <div className="flex items-center gap-2 ml-auto z-20">
             <div className="hidden sm:flex items-center gap-2">
                <Link href="/" title="回到首頁" className="w-8 h-8 rounded-full bg-slate-800 text-cyan-400 border border-cyan-400 flex items-center justify-center text-xs hover:bg-slate-700 transition-colors"><i className="fa-solid fa-house"></i></Link>
